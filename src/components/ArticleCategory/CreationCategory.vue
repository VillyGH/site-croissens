<template>
  ...
  <BModal id="modal" v-model="modalShowed" no-footer title="Création de catégorie d'article">
    <label>Titre</label>
    ...
    <div class="float-right">
      <BButton class="mx-1 mt-3" variant="primary" @click="createArticleCategory">Ajouter</BButton>
      <BButton class="mx-1 mt-3" variant="secondary" @click="changeModalVisibility(false)">Fermer</BButton>
    </div>
  </BModal>
</template>
...
import {BModal, BFormInput, BFormTextarea, BButton, BLink} from "bootstrap-vue-next";
